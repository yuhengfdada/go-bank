...
// Source: github.com/yuhengfdada/go-bank/db (interfaces: Store)
...
import (
	...
	db "github.com/yuhengfdada/go-bank/db"
)
...
func (m *MockStore) AddAmount(arg0 context.Context, arg1 db.AddAmountParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAmount", arg0, arg1)
...
func (mr *MockStoreMockRecorder) AddAmount(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddAmount", reflect.TypeOf((*MockStore)(nil).AddAmount), arg0, arg1)
}
